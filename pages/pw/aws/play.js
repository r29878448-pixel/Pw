...
export default function AwsLivePlayer() {
  ...
  const videoTitle = title ? decodeURIComponent(title) : 'AWS Live Stream';
  ...
  useEffect(() => {
    ...
    step('Connecting to AWS live stream...', 10);
    console.log('🔍 Fetching AWS live stream from:', apiUrl);
